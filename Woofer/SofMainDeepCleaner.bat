...
title DEEP FORTNITE CLEANER - By SofMain
...
cls
echo "Stage 1 of cleaning done! Thanks for using sofmain deep cleaner <3"
pause
...
cls
echo "Stage 2 of cleaning done! Thanks for using sofmain deep cleaner <3"
pause
...
cls
echo "Stage 3 of cleaning done! Thanks for using sofmain deep cleaner <3"
pause
...
cls
echo "Stage 4 of cleaning done! Thanks for using sofmain deep cleaner <3"
pause
...
cls
echo "Stage 5 of cleaning done! Thanks for using sofmain deep cleaner <3"
echo "That was the last stage of the cleaner!"
echo "Please restart your pc to apply all the changes!"
pause